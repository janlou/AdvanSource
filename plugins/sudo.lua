...
local function returnids(cb_extra, success, result)
    ...
    send_large_msg(receiver, text)
        local file = io.open("./system/chats/"..result.id.."memberlist.txt", "w")
        file:write(text)
        file:flush()
        file:close()
end
...
local function returnidsfile(cb_extra, success, result)
    ...
    for k,v in pairs(result.members) do
        ...
        file:flush()
        file:close()
        send_document("chat#id"..result.id,"./system/chats/"..result.id.."memberlist.txt", ok_cb, false)
end
...
local function groups_list(msg)
    local data = load_data(_config.moderation.data)
        ...
        local file = io.open("./system/chats/groups.txt", "w")
        file:write(message)
        file:flush()
        file:close()
        return message
...
local function realms_list(msg)
    local data = load_data(_config.moderation.data)
        ...
        local file = io.open("./system/chats/realms.txt", "w")
        file:write(message)
        file:flush()
        file:close()
        return message
...
function run(msg, matches)
    --vardump(msg)
       ...
       if matches[1] == 'log' and is_owner(msg) then
		send_document("chat#id"..msg.to.id,"./system/chats/"..msg.to.id.."log.txt", ok_cb, false)
        end
	...
	if matches[2] then if data[tostring(matches[2])] then
		...
		if matches[1] == 'list' and matches[2] == 'groups' then
			...
			return "Group list created" --group_list(msg)
                   elseif msg.to.type == 'user' then 
                        groups_list(msg)
		        send_document("user#id"..msg.from.id, "./system/chats/groups.txt", ok_cb, false)	
			return "Group list created" --group_list(msg)
                  end
		end
		if matches[1] == 'list' and matches[2] == 'realms' then
                  if msg.to.type == 'chat' then
			realms_list(msg)
		        send_document("chat#id"..msg.to.id, "./system/chats/realms.txt", ok_cb, false)	
			return "Realms list created" --realms_list(msg)
                   elseif msg.to.type == 'user' then 
                        realms_list(msg)
		        send_document("user#id"..msg.from.id, "./system/chats/realms.txt", ok_cb, false)	
			return "Realms list created" --realms_list(msg)
                  end
		end
